...
def tf_workspace(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        name = "isl",
        build_file = clean_dep("//third_party/isl:isl.autogenerated.BUILD"),
        sha256 = "cf4ec18538df940ad5d5760af1246825cc58dd295241ab41d3f3962b24f55199",
#        sha256 = "f81ca9a8ff02c18c78655d023e266fd4177f4dcc057bcab8c14eb48fb6e9c7ef", # for 0.18
        strip_prefix = "",
        urls = [
            "http://isl.gforge.inria.fr/isl-0.20.tar.gz",
        ],
    )

    tf_http_archive(
        name = "pet",
        build_file = clean_dep("//third_party/pet:pet.autogenerated.BUILD"),
        sha256 = "d5fe65c6409eb5a60628c6b5da5e06d6a742247e64525a11aa3baf74f2703862",
        strip_prefix = "",
        # TODO: Temporary release download link from Github. Need to find a more permanent solution for this
        urls = [
            "https://github.com/ysahil97/test_pet/releases/download/pet/pet.tar.gz",
        ]
    )
